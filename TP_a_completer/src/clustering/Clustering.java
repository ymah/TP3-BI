...
public class Clustering{
	...
	private void choisirCentres(){
		...
		System.out.println("Coordonnees des centres initiaux :");
	...
	private boolean etape() throws ClusterException{
		numEtape++;
		System.out.println("Etape "+numEtape);
		...
		*/	}
		...
		if (change){
			...
			for (int i=0; i<this.lesClusters.length; i++){
				System.out.println("Cluster "+i+" : "+this.lesClusters[i].size());
			}
