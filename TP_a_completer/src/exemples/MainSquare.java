...
public class MainSquare{
	...
	public static void main(String argv[]) throws ClusterException {
		if (argv.length < 2) {
			...
			if ("euclidienne".equals(distance)){
				dist = new DistanceEuclidienne() ;
			} else if ("minkowski".equals(distance)){
				dist = new DistanceMinkowski(Double.parseDouble(argv[3]));
			} else if ("manhattan".equals(distance)){
				dist = new DistanceManhattan();
			}
